...
const LEGAL_LINKS = [
  ...
  { href: '/risk-disclosure', labelKey: 'footer.risk' },
  { href: '/credits-policy', labelKey: 'footer.credits' },
            ...
            <div className="flex items-center gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 border border-white/10 hover:border-primary/30 transition-all"
